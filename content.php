...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'sidebar' ) ); ?>
	...
	<footer class="entry-meta">
		...
		<span class="sep"> | </span>
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'sidebar' ), __( '1 Comment', 'sidebar' ), __( '% Comments', 'sidebar' ) ); ?></span>
		<?php endif; ?>
